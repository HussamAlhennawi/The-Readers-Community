            ...
            <ul class="nav">
                ...
                <li class="active">
                    <a href="{{ route('category.index')}}">
                        <i style="margin-left: 50px;" class="fas fa-layer-group"></i>
                        <p>categories</p>
                    </a>
                    <br>
                    <ul style="list-style: none;">
                        <li class="active">
                            <a href="{{ route('category.show', $category)}}">
                                <strong><p style="text-align: center">#&nbsp;{{$category->name}}</p></strong>
                            </a>
                        </li>
                        <br>
                    </ul>
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <strong>#&nbsp;{{$category->name}} Statistics :&nbsp;&nbsp;</strong>
                    <i class="fas fa-book"></i>&nbsp;&nbsp;{{@count($books)}} Books in the #&nbsp;{{$category->name}} category &nbsp;&nbsp;
                </div>
                    ...
                    <div style="margin-left: 200px;" class="card">
                        ...
                        <div class="card-body">
                            @foreach($categories as $category)
                                   <strong><a href="{{ route('category.show', $category)}}">#{{$category->name}}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                            @endforeach
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <div class="author">
                                    ...
                                    <p class="description">
                                        Year of publish: {{$book->publish_year}}
                                    </p>
                                    <p class="description">
                                    ...
                                    @else
                                        @foreach($count_rates_for_books as $count_rate)
                                            @if($book->id == $count_rate->book_id)
                                                ...
                                                <div class="">
                                                    <hr>
                                                    <strong>Des:</strong> {{$book->description}}
                                                </div>
                                </div>
