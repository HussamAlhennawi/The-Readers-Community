                ...
                <li class="active">
                    ...
                    <ul style="list-style: none;">
                        ...
                        <ul style="list-style: none;">
                            ...
                            <li class="active"><a href= {{ route('group.dis',$group)}}>
...
{{--                    <i class="fas fa-user-friends"></i>&nbsp;&nbsp;{{count($active_members_ids_in_the_group)}} Members--}}
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navigation">
                    <form method="GET" action="{{ route('group.dis',$group)}}">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.discussion').click(function () {
            ...
            $.ajax({
                type: "get",
                url: "{{ROUTE('message')}}?discussion_id=" + discussion_id, // need to create this route
                data: "",
                cache: false,
        ...
        $(document).on('keyup', '.input-text input', function (e) {
            ...
            if (e.keyCode == 13 && message != '' && discussion_id != '') {
                ...
                $.ajax({
                    type: "post",
                    url: "{{ url('/sendmessage') }}", // need to create this post route
                    dataType: "json",
                    data: {
